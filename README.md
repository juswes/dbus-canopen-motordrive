...
## How to connect the Curtis F controller to a Victron GX product
...
## How to connect the Curtis E/SE controller to a Victron GX product

| Role| RJ45 pin # | Controller pin |
|-----|------------|----------------|
| CAN Ground | 3 (Green/White) | 7 |
| CAN High | 7 (Brown/White) | 23 |
| CAN Low | 8 (Brown) | 35 |

To enable CAN termination on the controller, connect CAN TERM H (pin 21) and CAN TERM L (pin 34) together.

### Curtis E/SE series support
...
2. Select either `VE.Can & CANopen E-drive (250 kbit/s)` or `CANopen E-drive (500 kbit/s)`.
...
## Sevcon Gen4 AC - Which SDOs are used by the driver
...
## Curtis F series - Which SDOs are used by the driver
...
## Curtis E/SE series - Which SDOs are used by the driver

| index | subindex | Description |
|------------|----------------|---|
| 0x1018 | 1 | Vendor ID |
| 0x3464 | 0 | Model Number |
| 0x1018 | 4 | Controller Serial Number |
| 0x32C4 | 0 | Capacitor Volts, 1 = 0.015625V |
| 0x359E | 0 | Battery Current, 1 = 0.1A |
| 0x3207 | 0 | Motor RPM |
